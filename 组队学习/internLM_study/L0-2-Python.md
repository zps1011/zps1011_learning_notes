...
打开本地电脑的 VSCode，利用 Remote - SSH 插件连接远程开发机（详细步骤可参考[书生大模型实战营【第三期】学习笔记 - 入门岛 - Linux 基础](https://github.com/zps1011/zps1011_learning_notes/blob/main/%E7%BB%84%E9%98%9F%E5%AD%A6%E4%B9%A0/internLM_study/L0-1-Linux.md)），在远程开发机中创建一个新的 python 文件，将`1.Python实现wordcount`中实现的内容复制到该文件中，并在终端中输入以下命令，调试该文件：
...
本次实战主要通过 python 实现了一个 wordcount 函数，用于统计英文字符串中每个单词出现的次数。通过 VSCode 连接远程开发机，体验并尝试了 debug 的全流程，回顾了 pdb 调试过程。
